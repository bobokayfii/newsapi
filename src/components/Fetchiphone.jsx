  ...
  const fetchData = async () => {
    try {
      const response = await axios.get(
        "https://newsapi.org/v2/everything?q=apple&from=2023-07-13&to=2023-07-13&sortBy=popularity&apiKey=0928ae4ad07243098d26b27f2663ea58"
      );
